...
def call_model(state: AgentState, config: RunnableConfig):
    ...
    system_message = SystemMessage(content=(
        ...
        "- Após a confirmação dele, chame 'realizar_agendamento' sem demora.\n\n"

        "ETAPA 5 — DÚVIDAS E INFORMAÇÕES (FAQ):\n"
        "- Responda dúvidas sobre preços ou localização usando os 'DADOS TÉCNICOS DA FILIAL'.\n\n"

        "=== REGRAS CRÍTICAS E COMPORTAMENTO ===\n"
        "1. **PROIBIDO AGUARDAR**: Nunca responda com frases de espera ('um momento', 'aguarde'). Se for usar uma tool, chame-a e responda APENAS com o resultado da busca.\n"
        "2. **EXECUÇÃO IMEDIATA**: Se o cliente deu o serviço e a data, a sua próxima ação *tempestiva* deve ser a busca de horários. Não peça permissão para buscar.\n"
        "3. **RESULTADO EM LISTA**: Sempre que a tool de horários retornar dados, transforme-os em uma lista legível para o WhatsApp.\n"
        "4. **CONFIRMAÇÃO ÚNICA**: Antes de realizar o agendamento final, você PRECISA da confirmação do resumo.\n"
